...
class Lion extends Factory {

	var $_opt;

	function __construct(){
		parent::__construct();
		$this->_cookies_file = realpath('./cookies/lion_air.txt');
	...
	function src($flight_type){
		...
		$file_arr = array(
			'./components/maskapai/libraries/factory/lion_html/li_1/lion.htm',			
			'./components/maskapai/libraries/factory/lion_html/li_3/lion.htm',
			'./components/maskapai/libraries/factory/lion_html/li_4/lion.htm'
		);				
	...
	function plain(){
		echo $dom = file_get_html(realpath('./components/maskapai/libraries/factory/lion_html/li_4/lion.htm'));
	}
